...
import { Send, Github, User, TrendingUp, FileText, MessageSquare } from 'lucide-react';
...
const QUICK_ACTIONS = [
  {
    ...
    description: 'Get personalized insights based on your background and goals',
    prompt: "I'd like to analyze my career profile. Can you ask me the right questions to understand my background, experience, and aspirations so you can give me personalized guidance?",
  },
  {
    icon: TrendingUp,
    title: 'Skill Gap Detection',
    description: 'Identify missing skills for your target role with a learning plan',
    prompt: "I want to identify skill gaps for a role I'm targeting. Help me figure out what skills I'm missing and create a learning plan with timelines.",
  },
  {
    icon: FileText,
    title: 'Resume & Profile Feedback',
    description: 'Get actionable feedback to position yourself better',
    prompt: "I'd like feedback on how I present myself professionally. Can you ask me about my experience and give me specific suggestions to improve my resume and LinkedIn profile?",
  },
  {
    icon: MessageSquare,
    title: 'Interview Preparation',
    description: 'Practice with realistic mock interviews and get feedback',
    prompt: "I want to practice for a job interview. Ask me what role I'm interviewing for, then conduct a realistic mock interview and give me feedback on my answers.",
  },
];
...
export default function ChatPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hi! I'm your Digital Twin — an AI career coach powered by GPT-4 Turbo. I can help you analyze your career profile, detect skill gaps, refine your resume, or run a mock interview. Choose a topic below or ask me anything.",
      sender: 'ai',
      timestamp: new Date(),
    },
  ]);
          ...
          {currentPage === 'home' && (
            <>
              ...
              <div className="flex-1 flex flex-col gap-4 overflow-y-auto mb-6">
                ...
                {!hasStarted && (
                  <div className="mb-2 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">Your AI Career Coach</h2>
                    <p className="text-sm text-gray-600">Powered by GPT-4 Turbo. Get real, personalized guidance on your career path.</p>
                  </div>
                )}
                ...
                {messages.map((message) => (
                  ...
                  >
                    <div
                      className={`max-w-2xl px-5 py-3 rounded-2xl text-sm leading-relaxed font-medium whitespace-pre-wrap ${
                        message.sender === 'user'
              ...
              <form onSubmit={handleSendMessage} className="flex gap-3">
                <Input
                  type="text"
                  placeholder="Ask about your career, skills, resume, or interview prep..."
                  value={input}
            ...
            <div className="flex flex-col gap-6 overflow-y-auto">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Built on GPT-4 Turbo via OpenRouter, Digital Twin delivers state-of-the-art language understanding for accurate, nuanced career guidance tailored to your unique situation.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-gradient-to-t from-gray-50 to-white border-t border-gray-200 mt-8">
        <div className="max-w-5xl mx-auto px-8 py-10">
          <div className="grid grid-cols-3 gap-12 mb-8">
            <div>
              <h3 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-wider">About</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                Your AI-powered digital twin designed to guide you through professional growth, skill development, and career advancement.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                <li><a href="#" className="hover:text-blue-900 transition-colors font-medium">Documentation</a></li>
                <li><a href="#" className="hover:text-blue-900 transition-colors font-medium">API Reference</a></li>
                <li><a href="#" className="hover:text-blue-900 transition-colors font-medium">Support</a></li>
              </ul>
            </div>

            <div>
              <h3 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-wider">Connect</h3>
              <a
                href="https://github.com"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-blue-900 transition-colors font-medium text-sm"
              >
                <Github size={16} />
                View on GitHub
              </a>
